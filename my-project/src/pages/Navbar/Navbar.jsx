...
export const Navbar = () => {
  ...
  return (
    <nav className="flex flex-wrap justify-between bg-slate-700/55 items-center fixed top-0 left-0 w-full  font-semibold z-50 px-4 py-2">
      {/* Logo */}
      ...
      >
        <ul className="flex flex-col  md:flex-row items-center gap-4 md:gap-14 w-full md:w-auto py-4 md:py-0">
          <li className="w-full md:w-auto">
            <Link
              to="/"
              className="block text-white hover:bg-indigo-600 px-4 py-3 rounded-md text-lg hover:text-slate-300 cursor-pointer text-center"
